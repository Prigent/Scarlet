...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.item % 6 == 0) {
        ...
        attribute.frame = CGRectMake(rightSideSmallCellOriginX, lineOriginY +  _smallCellSize.height/2. + _itemSpacing/2., _smallCellSize.width, _smallCellSize.height);
    }else if (line % 2 == 0) {
        ...
        if (indexPath.item % 2 != 0) {
            attribute.frame = CGRectMake(_insets.left, lineOriginY+  _smallCellSize.height/2. + _itemSpacing/2., _smallCellSize.width, _smallCellSize.height);
        }else {
