...
- (void)getPhotos:(OLFacebookPhotosForAlbumRequestHandler)handler {
    if ([FBSDKAccessToken currentAccessToken]) {
        ...
        [request startWithCompletionHandler:^(FBSDKGraphRequestConnection *connection, id result, NSError *error) {
            ...
            NSError *parsingError = [NSError errorWithDomain:@"co.oceanlabs.FacebookImagePicker.kOLErrorDomainFacebookImagePicker" code:100 userInfo:@{NSLocalizedDescriptionKey: parsingErrorMessage}];
        ...
        handler(nil, [NSError errorWithDomain:@"co.oceanlabs.FacebookImagePicker.kOLErrorDomainFacebookImagePicker" code:99 userInfo:@{NSLocalizedDescriptionKey: message}], nil);
    }
}
