...
static const CGFloat CSToastVerticalMarging     = 50.0;
static const CGFloat CSToastCornerRadius        = 10.0;
static const CGFloat CSToastOpacity             = 0.8;
static const CGFloat CSToastBlockOpacity        = 0.3;
...
- (void)makeToastActivityMustBlock:(BOOL) block{
    [self makeToastActivity:CSToastActivityDefaultPosition mustBlock:block];
}

- (void)makeToastActivity:(id)position mustBlock:(BOOL) block{
    // sanity
