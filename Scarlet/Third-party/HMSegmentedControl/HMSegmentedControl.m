...
- (void)commonInit {
    ...
    self.font =  [UIFont fontWithName:@"HelveticaNeue" size:11.0f];
    self.textColor = [UIColor colorWithWhite:1 alpha:0.8];
    self.selectedTextColor = [UIColor colorWithWhite:1 alpha:0.8];

    self.opaque = NO;

    
    self.selectionIndicatorColor = [UIColor colorWithRed:34.0f/255.0f green:182.0f/255.0f blue:184.0f/255.0f alpha:1.0f];
...
- (CGRect)frameForSelectionIndicator {
    ...
    if (self.type == HMSegmentedControlTypeText &&  [self.sectionTitles count]>self.selectedSegmentIndex) {
    ...
    else
    {
        ...
        {
            if (self.segmentWidthStyle == HMSegmentedControlSegmentWidthStyleDynamic && [self.segmentWidthsArray count]>self.selectedSegmentIndex) {
